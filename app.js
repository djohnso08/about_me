...
console.log(school + ' contestant did/didn\'t know all the schools David attended');
if
(school.toUpperCase === 'YES' || 'Y'){
...
console.log(travel + ' contestant traveled to?\nDubai\nSingapore\nGreece\nMexico');
if
(travel.toLowerCase() === 'yes' || 'y'){
...
console.log(occupation + 'was/was not a ninja or pirate.');
